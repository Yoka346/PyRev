...
def mirror_coord_horizontal(coord) -> np.int8: ...
def mirror_coord_verical(coord) -> np.int8: ...
def mirror_coord_diag_a1a8(coord) -> np.int8: ...
def mirror_coord_diag_a8h1(coord) -> np.int8: ...
def rotate_coord_clockwise(coord) -> np.int8: ...
...
class Position:
    ...
    def undo(self, coord: BoardCoordinate, flip: np.int64) -> None: ...
